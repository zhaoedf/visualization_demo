...
def dtd_for_resnet(model: nn.Module, inp, n_classes=1000, scale=5000):
    ...
    saliency_map = saliency_map.detach().permute((0, 2, 3, 1)).cpu().numpy()
    saliency_map = np.sum(saliency_map, axis=3)
...
if __name__ == '__main__':
    ...
    image = Image.open(r'E:\Projects\GradCAM\testImage\origin2.png')
    ...
    saliency_map = dtd_for_resnet(model, image)[0]
